'use client';
import { Droplets, Lock, Mail, Key, Eye, ArrowRight } from 'lucide-react';
    ...
    <main className="bg-[#f6f6f8] dark:bg-[#101622] font-sans text-slate-900 dark:text-slate-100 antialiased h-screen w-full flex overflow-hidden absolute inset-0 z-50">
      ...
      >
        <div className="flex items-center gap-3 z-10">
          ...
          <p className="text-white font-bold text-lg tracking-wide uppercase opacity-90">AquaGov</p>
        </div>

        <div className="relative z-10 max-w-lg">
          <div className="mb-6">
            <svg className="text-white/40 w-16 h-16 transform rotate-180" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
              <path d="M14.017 21v-7.391c0-5.704 3.731-9.57 8.983-10.609l.995 2.151c-2.432.917-3.995 3.638-3.995 5.849h4v10h-9.983zm-14.017 0v-7.391c0-5.704 3.748-9.57 9-10.609l.996 2.151c-2.433.917-3.996 3.638-3.996 5.849h3.983v10h-9.983z" />
            </svg>
          </div>
          <h1 className="text-white text-4xl font-bold leading-tight mb-4">Water Security &amp; Drought Governance</h1>
          <p className="text-white/80 text-lg font-normal leading-relaxed">
            Ensuring sustainable water access for every community through data-driven governance and transparent resource management.
          </p>
        </div>
      ...
      <div className="w-full lg:w-1/2 flex flex-col justify-center items-center p-6 sm:p-12 relative bg-white overflow-y-auto">
        ...
        <div className="w-full max-w-[440px] flex flex-col gap-8">
          <div className="flex flex-col gap-2">
            ...
            <p className="text-slate-500 text-base">Please sign in with your government credentials.</p>
          </div>

          <form className="flex flex-col gap-5">
            <div className="flex flex-col gap-2">
              <Label htmlFor="email" className="text-slate-900 text-sm font-medium">Official Email</Label>
            ...
            <div className="flex items-center justify-between">
              <label className="flex items-center gap-2 cursor-pointer select-none">
                <input type="checkbox" className="h-4 w-4 rounded border-slate-300 text-[#135bec] focus:ring-[#135bec]/20" />
                <span className="text-sm text-slate-600">Remember Me</span>
              </label>
              <a href="#" className="text-sm font-medium text-[#135bec] hover:text-[#0e45b8] hover:underline transition-colors">
                Forgot Password?
              </a>
            </div>
            ...
            <Button
              type="submit"
              className="w-full bg-[#135bec] hover:bg-[#0e45b8] text-white font-medium py-3 h-auto shadow-sm shadow-blue-500/20 flex items-center justify-center gap-2"
            >
          ...
          <div className="pt-2 text-center border-t border-slate-100">
            <p className="text-sm text-slate-500">
              ...
              <a href="#" className="font-medium text-[#135bec] hover:text-[#0e45b8] hover:underline transition-colors">
                Request Access
              </a>
            </p>
          </div>
          ...
          <div className="mt-8 flex justify-center gap-6">
            <div className="flex items-center gap-2 opacity-50 grayscale hover:grayscale-0 hover:opacity-100 transition-all cursor-pointer">
              ...
              <span className="text-xs font-medium text-slate-800">Ministry of Water</span>
            </div>
            <div className="flex items-center gap-2 opacity-50 grayscale hover:grayscale-0 hover:opacity-100 transition-all cursor-pointer">
              <div className="h-6 w-6 bg-slate-400 rounded-full" />
              <span className="text-xs font-medium text-slate-800">National Drought Relief</span>
            </div>
          </div>
        </div>
      </div>
